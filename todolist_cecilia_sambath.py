# -*- coding: utf-8 -*-
"""ToDoList_Cecilia_SAMBATH.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vBmRX3TwuUHxcLGnXMRewMFqlVVSInIH
"""
...
def modifier_tache():
    selected_item = taches_tree.selection()
    if selected_item:
        updated_tache = tache_entry.get()
        updated_date = date_entry.get()

        taches_tree.item(selected_item, values=(updated_tache, updated_date))

        for tache_instance in tache_instances:
            if isinstance(tache_instance, Tache) and tache_instance.tache == taches_tree.item(selected_item)["values"][0]:
                tache_instance.tache = updated_tache
                tache_instance.date = updated_date
                break
...
if __name__ == "__main__":
    ...
    edit_button_taches = tk.Button(button_frame_taches, text="Modifier tache", command=modifier_tache)
    edit_button_taches.pack(side=tk.LEFT, padx=5)
